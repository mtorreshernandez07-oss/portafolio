...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        retrieveObjectNames, getObjectName, getObjectUUID, initObjectPicking,
...
registerOnClick('boton2', false, false, [0,1,2], false, function(event) {
    if (boton02 == 'on') {
        operateAnimation('PLAY', boton02, 0, 30, 'LoopOnce', 1, function() {
            boton02 = 'off';
        }, false);
    } else {
        operateAnimation('PLAY', boton01, 0, 30, 'LoopOnce', 1, function() {
            boton01 = 'on';
        }, false);
    }
    changeVis('imag_B1', true);
    changeVis('imag_B2', true);
    changeVis('imag_B3', true);
    changeVis('imag_B4', true);
    changeVis('imag_B5', true);
    changeVis('img_A1', false);
    changeVis('imag_A2', false);
    changeVis('imag_A3', false);
    changeVis('imag_A4', false);
}, function(event) {});

registerOnClick('boton1', false, false, [0,1,2], false, function(event) {
    if (boton01 == 'on') {
        operateAnimation('PLAY', boton01, 0, 30, 'LoopOnce', 1, function() {
            boton01 = 'off';
        }, false);
    ...
    changeVis('img_A1', true);
    changeVis('imag_A2', true);
    changeVis('imag_A3', true);
    changeVis('imag_A4', true);
    changeVis('imag_B1', false);
    changeVis('imag_B2', false);
    changeVis('imag_B3', false);
    changeVis('imag_B4', false);
    changeVis('imag_B5', false);
}, function(event) {});
